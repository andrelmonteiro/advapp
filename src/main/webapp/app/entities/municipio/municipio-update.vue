  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="advappApp.municipio.home.createOrEditLabel"
          data-cy="MunicipioCreateUpdateHeading"
          v-text="$t('advappApp.municipio.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('advappApp.municipio.ativo')" for="municipio-ativo">Ativo</label>
            <input
              type="number"
              class="form-control"
              name="ativo"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('advappApp.municipio.codigoIbge')" for="municipio-codigoIbge">Codigo Ibge</label>
            <input
              type="number"
              class="form-control"
              name="codigoIbge"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('advappApp.municipio.nome')" for="municipio-nome">Nome</label>
            <input
              type="text"
              class="form-control"
              name="nome"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('advappApp.municipio.estado')" for="municipio-estado">Estado</label>

  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="advappApp.estado.home.createOrEditLabel"
          data-cy="EstadoCreateUpdateHeading"
          v-text="$t('advappApp.estado.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('advappApp.estado.ativo')" for="estado-ativo">Ativo</label>
            <input
              type="number"
              class="form-control"
              name="ativo"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('advappApp.estado.codigoIbge')" for="estado-codigoIbge">Codigo Ibge</label>
            <input
              type="number"
              class="form-control"
              name="codigoIbge"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('advappApp.estado.nome')" for="estado-nome">Nome</label>
            <input
              type="text"
              class="form-control"
              name="nome"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('advappApp.estado.sigla')" for="estado-sigla">Sigla</label>
            <input
              type="text"
              class="form-control"
              name="sigla"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('advappApp.estado.pais')" for="estado-pais">Pais</label>

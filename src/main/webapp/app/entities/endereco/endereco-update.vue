  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="advappApp.endereco.home.createOrEditLabel"
          data-cy="EnderecoCreateUpdateHeading"
          v-text="$t('advappApp.endereco.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('advappApp.endereco.ativo')" for="endereco-ativo">Ativo</label>
            <input
              type="number"
              class="form-control"
              name="ativo"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('advappApp.endereco.atual')" for="endereco-atual">Atual</label>
            <input
              type="checkbox"
              class="form-check"
              name="atual"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('advappApp.endereco.bairro')" for="endereco-bairro">Bairro</label>
            <input
              type="text"
              class="form-control"
              name="bairro"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('advappApp.endereco.cep')" for="endereco-cep">Cep</label>
            <input
              type="text"
              class="form-control"
              name="cep"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('advappApp.endereco.complemento')" for="endereco-complemento">Complemento</label>
            <input
              type="text"
              class="form-control"
              name="complemento"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('advappApp.endereco.dataExclusao')" for="endereco-dataExclusao"
              >Data Exclusao</label
            >
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('advappApp.endereco.usuarioExclusaoId')" for="endereco-usuarioExclusaoId"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('advappApp.endereco.municipio')" for="endereco-municipio">Municipio</label>

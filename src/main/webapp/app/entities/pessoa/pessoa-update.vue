  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="advappApp.pessoa.home.createOrEditLabel"
          data-cy="PessoaCreateUpdateHeading"
          v-text="$t('advappApp.pessoa.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('advappApp.pessoa.ativo')" for="pessoa-ativo">Ativo</label>
            <input
              type="number"
              class="form-control"
              name="ativo"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('advappApp.pessoa.autoridade')" for="pessoa-autoridade">Autoridade</label>
            <input
              type="checkbox"
              class="form-check"
              name="autoridade"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('advappApp.pessoa.contato')" for="pessoa-contato">Contato</label>
            <input
              type="text"
              class="form-control"
              name="contato"
          ...
          <div class="form-group">
            <label v-text="$t('advappApp.pessoa.enderecos')" for="pessoa-enderecos">Enderecos</label>
            <select
              class="form-control"
              id="pessoa-enderecos"
              data-cy="enderecos"
          ...
          <div class="form-group">
            <label v-text="$t('advappApp.pessoa.processos')" for="pessoa-processos">Processos</label>
            <select
              class="form-control"
              id="pessoa-processos"
              data-cy="processos"
              multiple
              name="processos"
              v-if="pessoa.processos !== undefined"
              v-model="pessoa.processos"
            >
              <option
                v-bind:value="getSelected(pessoa.processos, processoOption)"
                v-for="processoOption in processos"
